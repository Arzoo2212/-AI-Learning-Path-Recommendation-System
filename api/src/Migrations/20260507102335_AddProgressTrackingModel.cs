...
{
    /// <inheritdoc />
    public partial class AddProgressTrackingModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserActivityLogs_Courses_RelatedCourseId",
                        column: x => x.RelatedCourseId,
                        principalTable: "Courses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserActivityLogs_LearningPaths_RelatedPathId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivityLogs_RelatedCourseId",
                table: "UserActivityLogs",
                column: "RelatedCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_UserActivityLogs_RelatedPathId",
                table: "UserActivityLogs",
